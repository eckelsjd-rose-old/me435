...
def handle_fire(fighter):
    fighter.has_fired = True
...
def main():
    ...
    # I/O
    left_button = gz.Button(22)
    right_button = gz.Button(23)
    fire_button = gz.Button(25)
    game_over_led = gz.LED(14) # red led
    fire_button.when_pressed = lambda : handle_fire(fighter)
    game_over_led.off()
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            # if fighter.has_fired and event.type == pygame.KEYDOWN:
            #     if not game_over:
        ...
        if fighter.has_fired:
            if not game_over:
                fighter.fire_sound.play()
                fighter.fire()
